...
const Collections = () => {
  ...
  const lookbookItems = [
    { id: 1, image: modelCoord1, name: "Sunset Co-ord Set", price: 2100 },
    { id: 2, image: modelCoord2, name: "Terracotta Dreams", price: 1850 },
    { id: 3, image: modelCoord3, name: "Sage Elegance", price: 2400 },
    { id: 4, image: modelCoord4, name: "Indigo Breeze", price: 1950 }
  ];

  // --- NEW: Dynamic State for Shop Items ---
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="relative h-[70vh] md:h-[80vh] overflow-hidden">
          <img src={collectionBanner} alt="Roots Rewritten Collection" className="w-full h-full object-cover" />
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Roots Rewritten is a celebration of heritage reimagined. Inspired by the timeless artistry of traditional Indian textiles...
            </p>
        ...
        {/* Shop the Collection Grid (Dynamic from Django) */}
        <section className="container mx-auto px-4 py-16">
          ...
          {loading ? (
             <div className="text-center py-12 text-muted-foreground animate-pulse tracking-widest">LOADING COLLECTION...</div>
          ) : (
